<x-layout>
    <div class="p-8">
        <div class="flex justify-between items-center">
            <h1 class="text-black font-bold text-2xl mb-4">Laporan Produk</h1>
        </div>

        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <form method="GET" action="{{ route('report') }}" class="flex items-center gap-3">
                <div class="relative">
                    <input type="text" name="date_range" id="date_range"
                        ...
                        placeholder="Pilih Rentang Tanggal" value="{{ request('date_range') }}" autocomplete="off">
        ...
        <div class="flex justify-start gap-3 my-4">
            <a href="{{ route('report.pdf', ['date_range' => request('date_range')]) }}"
            ...
            <a href="{{ route('report.excel', ['date_range' => request('date_range')]) }}"
        ...
        @include('dashboard.report._partials.table')
    </div>
