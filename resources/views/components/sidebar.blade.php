<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">Menu Utama</h3>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a href="{{ route('product') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            ...
                            <i class="fa-solid fa-pills w-[18px] text-center"></i>
                            Data Obat
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('category') }}"
                           ...
                           <i class="fa-solid fa-layer-group w-[18px] text-center"></i>
                            Kategori Obat
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('pembelian') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('pembelian') ? 'bg-graydark text-white' : 'text-black' }}">
                            <i class="fa-solid fa-truck-ramp-box w-[18px] text-center"></i>
                            Pembelian Obat
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('cashier') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('cashier') ? 'bg-graydark text-white' : 'text-black' }}">
                            <i class="fa-solid fa-cash-register w-[18px] text-center"></i>
                            Penjualan Obat (Kasir)
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('stock') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('stock') || request()->routeIs('log-stock') ? 'bg-graydark text-white' : 'text-black' }}">
                           <i class="fa-solid fa-boxes-stacked w-[18px] text-center"></i>
                            Stok Obat
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('report.sales') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('report') || request()->routeIs('report.sales') ? 'bg-graydark text-white' : 'text-black' }}">
                           <i class="fa-solid fa-chart-line w-[18px] text-center"></i>
                            Laporan
                        </a>
                    </li>
            ...
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">Pengaturan</h3>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a href="{{ route('settings') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('settings') ? 'bg-graydark text-white' : 'text-black' }}">
                    ...
                    <li>
                        <a href="{{ route('backup') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('backup') ? 'bg-graydark text-white' : 'text-black' }}">
            ...
            @else
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">Menu Kasir</h3>
                <ul class="mb-6 flex flex-col gap-1.5">
                    <li>
                        <a href="{{ route('cashier') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                    ...
                    <li>
                        <a href="{{ route('cashier.stock-available') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('cashier.stock-available') ? 'bg-graydark text-white' : 'text-black' }}">
                            <i class="fa-solid fa-boxes-stacked w-[18px] text-center"></i>
                            Stok Tersedia
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('cashier.sold-products') }}"
                           class="group relative flex items-center gap-2.5 rounded-md px-4 py-2 font-medium duration-300 ease-in-out
                            hover:bg-graydark hover:text-white
                            {{ request()->routeIs('cashier.sold-products') ? 'bg-graydark text-white' : 'text-black' }}">
                            <i class="fa-solid fa-chart-line w-[18px] text-center"></i>
                            Produk Terjual
                        </a>
                    </li>
